            ...
            ? ((this.loc = e.fn.datepicker.language[t]),
              this.loc ||
                (console.warn(
                  "Can't find language \"" +
                    t +
                    '" in Datepicker.language, will use "ko" instead'
                ),
                (this.loc = e.extend(!0, {}, e.fn.datepicker.language.ko))),
              (this.loc = e.extend(
                !0,
                {},
                e.fn.datepicker.language.ko,
                e.fn.datepicker.language[t]
              )))
            : (this.loc = e.extend(!0, {}, e.fn.datepicker.language.ko, t)),
